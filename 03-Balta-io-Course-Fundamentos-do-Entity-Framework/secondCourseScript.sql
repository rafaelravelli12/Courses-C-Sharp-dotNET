...
CREATE TABLE [Post] (
    ...
    [LastUpdateDate] SMALLDATETIME NOT NULL DEFAULT '2024-01-15T01:29:26.1655531Z',
...
VALUES (N'20240115012926_InitialCreation', N'5.0.9');
GO
...
ALTER TABLE [Post] ADD DEFAULT '2024-01-15T01:43:12.4751282Z' FOR [LastUpdateDate];
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20240115014312_AddedGithubField', N'5.0.9');
GO
